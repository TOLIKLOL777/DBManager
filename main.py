...
def main():
    ...
    while True:
        print('''Выберите что хотите сделать (для выбора напишите номер действия):
    ...
    6:Выход.''')
        ...
        if answer == 2:
            ...
            for vacancy in vacancies:
                print(f'Работодатель: {vacancy[0]}, Вакансия: {vacancy[1]}, зарплата от {vacancy[2]} до {vacancy[3]}, ссылка {vacancy[4]}')
